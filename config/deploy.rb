...
role :web, "groupkuo.com"                          # Your HTTP server, Apache/etc
role :app, "groupkuo.com"                         # This may be the same as your `Web` server
role :db,  "groupkuo.com"   , :primary => true # This is where Rails migrations will run
